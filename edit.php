...
<body>
    ...
    <?php      $sorgu = $baglanti->query("SELECT * FROM players");
...
if ($_POST) { // Post olup olmadığını kontrol ediyoruz.
    ...
    if ($hex!="" && $Job!="") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
        ...
        if ($baglanti->query("UPDATE players SET license = '$hex', permission = '$Job', name = '$firstname', citizenid = '$Telephone' WHERE players='$_GET[id]'")) 
        {
