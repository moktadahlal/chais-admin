...
<h1 style="margin-top: 50px; text-align: center; width: 100%; color: #fff; font-size: 20px;">Chaos Panel - Whitelist List</h1>
<button data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="width: 500px; margin-left: 36.8%;" type="button" class="btn btn-success" >Add Whitelist</button><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Whitelist</h5>
...
$sorgu = $baglanti->query("SELECT * FROM whitelists order by id DESC"); 

while ($sonuc = $sorgu->fetch_assoc()) { 
  if (isset($sonuc['hex']) && isset($sonuc['dcid'])) {
      $hex = $sonuc['hex'];
      $discordid = $sonuc['dcid'];
      
      // Your code using $hex and $discordid variables
  } else {
      // Handle the case where 'hex' or 'dcid' keys are not set in the fetched data
  }
...
<tr>
  ...
  <td><a href="deletewhitelist.php?id=<?php echo $hex; ?>"<button class="btn btn-danger" type="button">Revoke</button></td>
